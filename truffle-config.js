...
// {
//   "kovan": {
//     "mnemonic": "12 words mnemonic or private key hex string",
...
module.exports = {
  ...
  networks: {
    ...
    kovan: {
      provider: () => new HDWalletProvider(secrets.kovan.mnemonic, `https://kovan.infura.io/v3/${secrets.kovan.projectId}`),
      network_id: 42,
      skipDryRun: true
    },
    live: {
